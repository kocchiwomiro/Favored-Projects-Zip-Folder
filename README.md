...
-A c-based client-server program for creating and storing Kamen Rider ocs.\
-A basic calculator.\
-A custom blog website utilizing React that updates for new posts.\
-A PHP quiz with defined questions and answers.\
-A student database in React for users to input and review new students (team-project, prioritzed stylization of application).\
